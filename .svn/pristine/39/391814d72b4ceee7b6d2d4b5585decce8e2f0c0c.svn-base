...
public class ChangeDirectoryTest {
  ...
  /**
   * Initialize related field for testing ChangeDirectory.
   * @throws Exception  An exception ChangeDirectory can throw. 
   */
  @Before
  public void setUp() {
  ...
  /**
   * test execute() for ChangeDirectory with only directory name.
   */
  @Test
  ...
  /**
   * test execute() for ChangeDirectory with path.
   */
  @Test
  ...
  /**
   * test execute() for ChangeDirectory with no change.
   */
  @Test
  public void executeTestNoChange() {
    /*
     * if ChangeDirectory to a non-existing directory, workingDirectory
     * shouldn't change
     */
